        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
             ...
             <form  action="../includes/functions.php" method="POST">
                            ...
                            <input type="number" step=".01"  id="entregado" name="entregado" class="form-control"  required>
                            <input type="hidden" name="accion" value="calculo_agro">
                      ...
                      <br>
                               ...
                               <a href="agroindustrial.php?categoria=AGROINDUSTRIAL" class="btn btn-danger">Cancelar</a>
